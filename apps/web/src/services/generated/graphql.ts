...
export type CreateBookMutation = { __typename?: 'Mutation', createBook: { __typename?: 'Book', id: string, title: string, description: string, publishedDate: any, author: { __typename?: 'Author', id: string, name: string } } };
